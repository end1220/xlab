...
namespace TwFramework
{
	public class BuildScript
	{
		...
		public static void BuildStandalonePlayer()
		{
			...
			// Build and copy AssetBundles.
			BuildScript.BuildAssetBundles();
			BuildScript.CopyAssetBundlesTo(Path.Combine(Application.streamingAssetsPath, AppConst.PersistentDataPath));
		...
		static void CopyAssetBundlesTo(string outputPath)
		{
			...
			string outputFolder = Utils.GetPlatformName();

			// Setup the source folder for assetbundles.
			var source = Path.Combine(Path.Combine(System.Environment.CurrentDirectory, AppConst.PersistentDataPath), outputFolder);
