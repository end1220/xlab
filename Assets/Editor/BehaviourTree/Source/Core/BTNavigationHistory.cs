...
namespace Lite.BevTreeEditor
{
	...
	public class BTNavigationHistory : ISerializationCallbackReceiver
	{
		...
		private void SaveRecentFiles()
		{
			...
			EditorPrefs.SetString(PlayerSettings.productName + ".Lite.BevTree.RecentFiles", m_stringBuilder.ToString());
		}

		private void LoadRecentFiles()
		{
			string saveData = EditorPrefs.GetString(PlayerSettings.productName + ".Lite.BevTree.RecentFiles");
