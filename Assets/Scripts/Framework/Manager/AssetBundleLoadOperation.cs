...
namespace Lite
{
	...
	public class AssetBundleLoadLevelOperation : AssetBundleLoadOperation
	{
		...
		public override bool Update ()
		{
			...
			LoadedAssetBundle bundle = App.resManager.GetLoadedAssetBundle(m_AssetBundleName, out m_DownloadingError);
			if (bundle != null)
			{
				if (m_IsAdditive)
	...
	public class AssetBundleLoadManifestOperation : AssetBundleLoadAssetOperationFull
	{
		...
		public override bool Update ()
		{
			...
			if (m_Request != null && m_Request.isDone)
			{
				App.resManager.AssetBundleManifestObject = GetAsset<AssetBundleManifest>();
				return false;
			}
			else
				return true;
	...
	public class AssetBundleLoadOperationPure : AssetBundleLoadOperation
	{
		...
		public override bool Update()
		{
			...
			m_bundle = App.resManager.GetLoadedAssetBundle(m_AssetBundleName, out m_DownloadingError);
