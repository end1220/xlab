...
public struct Int3
{
    ...
    {
        zero = new Int3(0, 0, 0);
        one = new Int3(1000, 1000, 1000);
        half = new Int3(500, 500, 500);
        forward = new Int3(0, 0, 1000);
        up = new Int3(0, 1000, 0);
        right = new Int3(1000, 0, 0);
    }
    ...
    {
        return new Int3(IntMath.Divide((int) ((lhs.y * rhs.z) - (lhs.z * rhs.y)), 1000), IntMath.Divide((int) ((lhs.z * rhs.x) - (lhs.x * rhs.z)), 1000), IntMath.Divide((int) ((lhs.x * rhs.y) - (lhs.y * rhs.x)), 1000));
    }
